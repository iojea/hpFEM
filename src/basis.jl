...
"""
struct FTuple{N,T<:NTuple{N,Function}}
    data::T
end
FTuple(x...) = FTuple(x)

const UFT = Union{Nothing,FTuple}
"""
    Basis():
...
"""
struct Basis{N1,N2,I<:Integer,T<:AbstractFloat,Tb<:UFT,T∇<:UFT,Tdiv<:UFT,TΔ<:UFT}
    dim::I
