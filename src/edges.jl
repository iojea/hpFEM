...
@inline ismarked(e::Pair{EdgeHP{I},EdgeProperties{P,Bool}}) where {I<:Integer,P<:Integer}       = ismarked(e.second)
...
@inline setdegree!(e::Pair{EdgeHP{I},EdgeProperties{P,Bool}},deg) where {I<:Integer,P<:Integer} = (e.second(e),deg)
@inline nodes(e::Pair{EdgeHP{I},EdgeProperties{P,Bool}}) where {I<:Integer,P<:Integer} = nodes(first(e))
